...
const VN_ADMIN_PORTAL_RUNTIME_VERSION = 'vnext-portal-1.7.3';
const VN_ADMIN_PORTAL_LEGACY_RUNTIME_VERSIONS = Object.freeze([
  ...
  'vnext-portal-1.7.1', 'vnext-portal-1.7.2', 'vnext-portal-1.8.0'
]);
...
function vNextAdminPortalUsesV2Tables_(runtimeVersion) {
  ...
  return version === VN_ADMIN_PORTAL_RUNTIME_VERSION ||
    ['vnext-portal-1.1.0', 'vnext-portal-1.2.0', 'vnext-portal-1.3.0', 'vnext-portal-1.4.0',
      ...
      'vnext-portal-1.7.2', 'vnext-portal-1.8.0'].indexOf(version) >= 0;
}
