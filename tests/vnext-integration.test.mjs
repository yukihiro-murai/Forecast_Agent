...
async function checkPortalRuntimeBoundary() {
  ...
  assert.equal(bundle.version, 'vnext-portal-1.7.17');
...
async function checkAdminRecoveryContracts() {
  ...
  assert.ok(source.includes('function vNextAdminUpdateHubRuntimeInHub_(') &&
    ...
    source.includes('function vNextAdminPeekCentralRuntimeMarkers_(') &&
    ...
    source.includes('requiresSidebarReload: changed === true') &&
